...
export default  function SinglePost() {
   ...
   return (
        ...
        <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full "><BlockContent blocks={singlePost.body} projectId="62wlhcg8" dataset="production"  /></div>
